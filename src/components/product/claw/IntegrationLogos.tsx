    ...
    <section className="py-20 px-6 relative z-10 border-y border-white/5 bg-surface">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <span className="text-blue-500 font-semibold tracking-wider uppercase text-sm">{il.badge}</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {systems.map((sys, idx) => (
            <motion.div
              ...
              className="flex flex-col items-center justify-center h-20 rounded-xl border border-white/5 bg-white/[0.02] cursor-default transition-all hover:border-white/10 hover:shadow-[0_0_12px_rgba(59,130,246,0.08)]"
            >

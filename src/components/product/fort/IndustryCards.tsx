    ...
    <section className="py-24 px-6 relative z-10 bg-surface">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-blue-500 font-semibold tracking-wider uppercase text-sm">{ic.badge}</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {industries.map((ind, idx) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="group bg-surface-elevated border border-white/10 rounded-2xl p-6 hover:border-white/20 transition-all"
            >

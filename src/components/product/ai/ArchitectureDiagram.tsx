        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-0">
            ...
            <div className="flex-1 space-y-3">
              ...
              {tx.nodes.map((item, idx) => (
                <motion.div
                  ...
                  className="bg-surface-elevated border border-white/10 rounded-lg px-4 py-3 text-sm text-zinc-300 text-center"
                >
                  {item}
                </motion.div>
              ))}
            ...
            <div className="flex flex-col items-center mx-8 py-4">
              <div className="hidden md:block w-px h-8 bg-gradient-to-b from-transparent to-blue-500/30" />
              ...
              <motion.div
                ...
                className="bg-blue-600/20 border border-blue-500/40 rounded-2xl px-8 py-6 text-center my-4"
              >
                <div className="text-lg font-bold text-white mb-1">VxonAI</div>
                <div className="text-xs text-blue-400">{tx.deployNode}</div>
              </motion.div>
              <div className="hidden md:flex flex-col items-center gap-1">
                {[0, 1, 2].map((i) => (
                  <div key={i} className="w-1 h-1 rounded-full bg-blue-500/40" />
              ...
              <div className="hidden md:block w-px h-8 bg-gradient-to-b from-blue-500/30 to-transparent" />
            </div>

            {/* Right: Invisible wall */}
            <div className="flex-1 flex items-center justify-center">
              <div className="border-2 border-dashed border-red-500/20 rounded-xl px-8 py-12 text-center">

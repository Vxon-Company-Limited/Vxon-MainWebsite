          ...
          {tx.items.map((v, idx) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="bg-surface-elevated border border-white/10 rounded-2xl p-8 hover:border-emerald-500/20 transition-all text-center"
              >
                <div className="w-14 h-14 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mx-auto mb-6 text-emerald-400">

...
const socialLinks: { name: string; href: string; icon: React.ReactNode }[] = [
  {
    name: 'GitHub',
    href: 'https://github.com/Vxon/vxon',
    icon: GithubSvg,
  },
  {
    name: 'AtomGit',
    href: 'https://atomgit.com/Vxon/vxon',
    icon: AtomGitIcon,
  },
  {
    name: 'Gitee',
    href: 'https://gitee.com/Vxon/vxon',
    icon: GiteeIcon,
  },
  {
    name: 'Docker',
    href: 'https://hub.docker.com/r/vxon/vxon',
    icon: DockerIcon,
  },
  {
    name: 'QQ',
  ...
  {
    name: 'Product Hunt',
    href: 'https://www.producthunt.com/products/vxon',
...
const relatedProjects: { label: string; href: string }[] = [
  ...
  },
  {
    ...
    href: 'https://github.com/Vxon/neko-api-key-tool',
  },
];
...
const friendshipLinks: { label: string; href: string }[] = [
  ...
  {
    label: 'vxon-horizon',
    href: 'https://github.com/Vxon/vxon-horizon',
  },
...
const translations: Record<string, FooterTranslation> = {
  zh: {
    ...
    copyright: '© 2025 Vxon. All Rights Reserved.',
  },
  en: {
    sections: {
      about: {
  ...
  es: {
    sections: {
      ...
      friendshipLinks: 'Enlaces amigos',
    },
    copyright: '© 2025 Vxon. All Rights Reserved.',
  },
};

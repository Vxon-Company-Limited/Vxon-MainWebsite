...
This document provides methods and best practices for updating the Vxon system to ensure a smooth upgrade to the latest version.
...
2.  **Check update logs**: Review the update content for the latest version on [GitHub Releases](https://github.com/Vxon/vxon/releases)
...
If you have deployed Vxon using a single Docker container, you can update by following these steps:
...
2.  Find the Vxon application and click the **Upgrade** button
...
2.  Find the Vxon container, click **More** -> **Recreate**
...
If you have deployed Vxon by compiling from source code, the update steps are as follows:

...
This document provides all environment variables supported by Vxon and their configuration instructions. You can customize the system's behavior by setting these environment variables.

<Callout type="info" title="Tip">
  Vxon supports reading environment variables from `.env` files. Please refer to the `.env.example`
...
| Environment Variable          | Description                                    | Default Value             | Example                                                                                                                             |
| ----------------------------- | ---------------------------------------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `SQL_DSN`                     | Database connection string                     | SQLite (`one-api.db`)     | MySQL: `SQL_DSN=root:123456@tcp(localhost:3306)/vxon` \| PostgreSQL: `SQL_DSN=postgresql://root:123456@postgres:5432/vxon` |
...
| `SQLITE_PATH`                 | SQLite database path                           | `one-api.db`              | `SQLITE_PATH=/var/lib/vxon/vxon.db`                                                                                        |
...
| `FRONTEND_BASE_URL`               | Frontend base URL (used by slave nodes, redirects unmatched routes to this address) | -             | `FRONTEND_BASE_URL=https://<your-vxon-domain>` |
...
| `PYROSCOPE_APP_NAME`          | Application name for reporting                 | `vxon`     | `PYROSCOPE_APP_NAME=my-api`  |
...
| `HOSTNAME`                    | Hostname label for reporting                   | `vxon`     | `HOSTNAME=node-1`            |

...
This document details the Docker Compose configuration options for Vxon, applicable to various deployment scenarios.

## Basic Configuration Structure

The Docker Compose configuration file `docker-compose.yml` defines how the Vxon service and its dependent services (such as MySQL, Redis) are deployed.
...
For testing purposes, you can use the following simplified version, which only includes the Vxon service itself:
...
### Vxon Service Configuration

| Parameter        | Description                                                                    |
| ---------------- | ------------------------------------------------------------------------------ |
| `image`          | Image name, usually `vxon/vxon:latest` to get the latest version      |
...
| `environment`    | Environment variable settings, used to configure Vxon behavior              |
...
Vxon supports various environment variable configurations. Here are some commonly used ones:

| Environment Variable | Description                                         | Example                               |
| -------------------- | --------------------------------------------------- | ------------------------------------- |
| `SQL_DSN`            | Database connection string                          | `root:123456@tcp(mysql:3306)/vxon` |

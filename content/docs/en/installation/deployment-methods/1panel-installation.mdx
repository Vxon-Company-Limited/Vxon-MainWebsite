...
This document provides a graphical tutorial for deploying Vxon using the 1Panel panel.
...
<Callout type="info" title="Search for Applications">
  Go to the application list in the App Store, find the Vxon application under the [AI] category, and install it.
</Callout>
...
<Callout type="info" title="Install Application">
  Configure Vxon application parameters on the installation page:
</Callout>

- **Name**: The name of the Vxon application to be created
- **Version**: Select the version of Vxon
- **Port**: The service port for the Vxon application
...
<Callout type="info" title="Confirm Installation">
  Click Confirm to start the installation. The page will automatically redirect to the installed applications list. Wait for the Vxon application status to change to Started.
</Callout>
...
1. In the 1Panel application list, click the **Parameters** button for the Vxon application
...
<Callout type="info" title="Access Application">
  - On the `Installed` page, click `Jump` to enter the Vxon WebUI page
...
2. Find the Vxon application, click the **Upgrade** button
...
- [GitHub Repository](https://github.com/Vxon/vxon)
...
This document provides a graphical tutorial for deploying Vxon using the Baota Panel Docker feature.
...
4. Configure the following basic options:
   - **Container Name**: Customizable, defaults to `vxon`
...
1. Create a website directory in Baota Panel, such as `/www/wwwroot/vxon`
...
3. Enter Image Name: `vxon/vxon:latest`
...
6. Fill in the following information:
   - **Container Name**: `vxon` (customizable)
   - **Image**: Select the `vxon/vxon:latest` image you just pulled

...
This document provides detailed configuration steps and best practices for Vxon cluster deployment, helping you build a highly available, load-balanced distributed system.
...
The Vxon cluster adopts a master-slave architecture design:

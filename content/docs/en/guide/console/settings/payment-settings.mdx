...
- type: Channel identifier, used for backend routing and order placement.
  ...
  - Detailed logic can be found in the backend controller `controller/topup.go` (Reference: [controller/topup.go](https://github.com/Vxon/vxon/blob/main/controller/topup.go)).
...
- Detailed implementation logic can be found in the backend controller [controller/topup.go](https://github.com/Vxon/vxon/blob/main/controller/topup.go)

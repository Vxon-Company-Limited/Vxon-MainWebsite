...
description: Learn about Vxon, the next-generation AI Gateway and Asset Management System
---
...
Vxon is a next-generation AI foundation platform, providing unified infrastructure for your AI applications. It hosts all AI applications, manages your digital assets, and connects to a future unified interface platform.

<Callout type="info">
  Vxon seamlessly integrates with mainstream global AI service providers, including OpenAI, Anthropic, Google
...
Vxon adopts the **GNU AGPLv3** open-source license, which can be used for free as long as the terms of the open-source license are followed.

<Callout type="warn">
  Before using Vxon, please read the complete license terms in the [Project
  LICENSE](https://github.com/Vxon/vxon/blob/main/LICENSE).
</Callout>

### Open Source License (AGPLv3)

Under AGPLv3, you are free to use, modify, and distribute Vxon.
...
If your organization's policy does not permit the use of AGPLv3 licensed software, or if you wish to circumvent the open-source obligations of AGPLv3, please send an email to: [support@vxon.ai](mailto:support@vxon.ai)

### Contributions

All contributions to Vxon are licensed under AGPLv3.
...
- In case of dispute, please refer to the official [LICENSE](https://github.com/Vxon/vxon/blob/main/LICENSE) document

## Disclaimer

<Callout type="error">Before using Vxon, please read and understand these important statements.</Callout>
...
<Callout type="warn">
  Vxon is provided "as is" without any warranties of any kind. Developers and maintainers are not liable for any damages or legal issues arising from the use of this software.
</Callout>
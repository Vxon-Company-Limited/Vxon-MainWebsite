...
description: FluentRead configuration guide — open-source browser translation plugin with 20+ engines and AI model support. Connect to Vxon for immersive bilingual reading.
---

<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the Vxon console, you can add
...
### Import Configuration from Vxon Console (Recommended)

After the FluentRead plugin is installed in your browser, opening the Vxon console -> Token Management page will display a prompt to add FluentRead.
...
After confirming the import, the Vxon configuration in FluentRead will be enabled.
...
| ------------------- | --------------------------------------- |
| Translation Service | Vxon                                  |
| Access Token        | Vxon Key                              |
| Vxon Endpoint     | Vxon Deployment Address (without /v1) |

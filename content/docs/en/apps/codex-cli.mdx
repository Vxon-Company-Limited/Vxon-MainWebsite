...
description: Codex CLI installation and setup guide — configure this terminal-based AI coding agent with Vxon on Windows, macOS, and Linux. Supports sandboxing and patch editing.
---

...
本文档提供了Vxon系统的更新方法和最佳实践，以确保您的系统平稳升级到最新版本。
...
1. **备份数据**：备份数据库和重要配置文件
2. **查看更新日志**：在[GitHub Releases](https://github.com/Vxon/vxon/releases)查看最新版本的更新内容
...
如果您使用单个Docker容器部署了Vxon，可以按照以下步骤更新：
